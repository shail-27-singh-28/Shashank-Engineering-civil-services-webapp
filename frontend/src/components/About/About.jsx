      ...
      <section className="flex justify-center items-center dark:bg-gray-900 bg-white h-screen py-10">
        <div className="border-2 border-blue-500 flex flex-col md:flex-row bg-white rounded-lg shadow-lg max-w-6xl w-full overflow-hidden">
          <div className="flex-1 p-4 dark:text-white dark:bg-gray-500">
            <h1 data-aos="fade-up" className="text-center text-5xl mb-5">About Us</h1>
            <p data-aos="fade-up" data-aos-delay="300" className="text-center text-lg leading-relaxed mb-5">
